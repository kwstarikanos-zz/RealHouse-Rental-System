(function () {
    ...
    angular.module('BlurAdmin.pages.hostPanel')
        .controller('hostPanelCtrl', hostPanelCtrl);

    /** @ngInject */
    function hostPanelCtrl($scope, $resolve, $rootScope, promise, $state, Session, alert, focus, $mdDialog, toastr, HTTP_STATUS) {
        ...
        $scope.reservations = [
            {
                ...
                "room_id": 10,
                "renter": "peterthunder",
                "checkInDate": 1500595200000,
                "checkOutDate": 1500854400000,
                "guests": 5,
                "approved": true,
                "created": 1500465142000,
                "total_cost": 600
            },
            {
                "id": 18,
                ...
                "renter": "peterthunder",
                "checkInDate": 1500595200000,
                "checkOutDate": 1500768000000,
                "guests": 4,
                "approved": false,
                "created": 1500648365000,
                "total_cost": 90
            },
            {
                "id": 19,
                ...
                "guests": 5,
                "approved": false,
                "created": 1500648956000,
                "total_cost": 90
            }
        ];

        /*Insert room action button*/
        $scope.roomInsetDialog = function ($event) {
            $mdDialog.show({
                controller: 'insertRoomDialogCtrl',
                templateUrl: 'app/pages/hostPanel/insertRoomDialog.tmpl.html',
        ...
        $(document).ready(function () {
            ...
            $('#roomsTable tfoot th').each(function () {
                var title = $(this).text();
                $(this).html('<input class="dtSearchInput" type="text" placeholder="Search ' + title + '" />');
            });

/*            $('#reservationsTable tfoot th').each(function () {
                var title = $(this).text();
                $(this).html('<input class="dtSearchInput" type="text" placeholder="Search ' + title + '" />');
            });*/
